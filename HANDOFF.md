...
This file is a placeholder. The maintained docs are:

- [`README.md`](README.md) — repo map and quick orientation
- [`AGENTS.md`](AGENTS.md) — coding-agent brief
- [`docs/SETUP.md`](docs/SETUP.md) — Mac + Hyper-V environment setup,
